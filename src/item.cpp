...
Item::Item(ItemTypeId itemTypeId) : itemType(Items::items.getItemTypeByServerId(itemTypeId))
{
    registerEntity();
}
...
ItemData::Container::Container(uint16_t capacity, const std::vector<Item> &items) : _capacity(capacity)
{
