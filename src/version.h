...
{
    MapVersion()
        : otbmVersion(OTBMVersion::OTBM4), clientVersion(ClientVersion::CLIENT_VERSION_NONE) {}

    MapVersion(OTBMVersion otbmVersion, ClientVersion clientVersion)
        : otbmVersion(otbmVersion), clientVersion(clientVersion) {}
