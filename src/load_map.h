...
namespace OTBM
{
  ...
  {
  public:
    OTBM1Deserializer(LoadBuffer &buffer) : buffer(buffer) {}
  ...
  {
  public:
    OTBM2Deserializer(LoadBuffer &buffer) : OTBM1Deserializer(buffer) {}
  };

  class OTBM3Deserializer : public OTBM2Deserializer
  {
  public:
    OTBM3Deserializer(LoadBuffer &buffer) : OTBM2Deserializer(buffer) {}
  };

  class OTBM4Deserializer : public OTBM3Deserializer
  {
  public:
    OTBM4Deserializer(LoadBuffer &buffer) : OTBM3Deserializer(buffer) {}
