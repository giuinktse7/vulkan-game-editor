...
inline int AppearanceFlagMarket::_internal_restrict_to_vocation_size() const {
  return restrict_to_vocation_.size();
}
...
inline ::tibia::protobuf::shared::VOCATION AppearanceFlagMarket::_internal_restrict_to_vocation(int index) const {
  return static_cast< ::tibia::protobuf::shared::VOCATION >(restrict_to_vocation_.Get(index));
}
...
inline void AppearanceFlagMarket::set_restrict_to_vocation(int index, ::tibia::protobuf::shared::VOCATION value) {
  ...
  restrict_to_vocation_.Set(index, value);
...
inline void AppearanceFlagMarket::_internal_add_restrict_to_vocation(::tibia::protobuf::shared::VOCATION value) {
  assert(::tibia::protobuf::shared::VOCATION_IsValid(value));
  restrict_to_vocation_.Add(value);
}
...
inline std::string* AppearanceFlagNPC::release_currency_quest_flag_display_name() {
  ...
  _has_bits_[0] &= ~0x00000004u;
  auto* p = currency_quest_flag_display_name_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (currency_quest_flag_display_name_.IsDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited())) {
